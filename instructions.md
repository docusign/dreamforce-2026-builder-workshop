...
7. Open **Consent for Change - Prepare Template** and confirm fields are correctly mapped to values from the Mailing Address Update form.</br><img src="images/CCA-img2.3.8.png" width="900"/></br>
